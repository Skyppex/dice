...
public static class OptionExtensions
{
    ...
    public static Option<TResult> Map<T, TResult>(this Option<T> option, Func<T, TResult> mapper)
    {
        ...
        return option.HasValue ? Some(mapper(option.Value!)) : None<TResult>();
    }

    public static TResult MapOr<T, TResult>(
        this Option<T> option,
    ...
    )
    {
        ...
        return option.And(other).IsSome()
            ? Some(zipper(option.Value!, other.Value!))
            : None<TResult>();
    }
