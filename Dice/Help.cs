...
public static class Help
{
    public static void Print()
    {
        ...
        builder.AppendLine(WriteExplanation("-e, --expr", "Print the expression used to calculate the result"));
        ...
        builder.AppendLine(WriteExplanation("(<expression>)", "Evaluate <expression> before whats outside the parens -> 1d6 * (1d6 + 2)"));
